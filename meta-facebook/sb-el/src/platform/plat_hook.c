...
ubc_vr_power_mapping_sensor ubc_vr_power_table[] = {
	...
	{ UBC_VR_RAIL_E_ASIC_P1V05_VDDC_HBM1357,
	  ...
	  "VR_ASIC_P1V05_VDDC_HBM1357_PWR_W",
	  { 0 } },
	...
	{ UBC_VR_RAIL_E_ASIC_P0V9_VDDQ_HBM1357,
	  ...
	  "VR_ASIC_P0V9_VDDQ_HBM1357_PWR_W",
	  { 0 } },
	...
	{ UBC_VR_RAIL_E_ASIC_P1V05_VDDC_HBM0246,
	  ...
	  "VR_ASIC_P1V05_VDDC_HBM0246_PWR_W",
	  { 0 } },
...
bool plat_get_vout_range(uint8_t rail, uint16_t *vout_max_millivolt, uint16_t *vout_min_millivolt)
{
	...
	if (get_pdr_table_critical_high_and_low_with_sensor_id(sensor_id, &critical_high,
							       &critical_low) != 0) {
		LOG_ERR("Get sensor threshold failed, sensor id: 0x%x", sensor_id);
		return false;
	}

	// unit:mv
	*vout_max_millivolt = (uint16_t)(critical_high * 1000);
