...
const vr_fault_info vr_fault_table[] = {
	...
	{ ARKE_VDDC_HBM0_HBM2_HBM4_HBM6, VR_POWER_FAULT_3_REG, BIT(6), true,
	...
	{ ARKE_VDDC_HBM1_HBM3_HBM5_HBM7, VR_POWER_FAULT_3_REG, BIT(2), true,
	...
	// VR Power Fault 4
	{ ARKE_VDDQ_HBM0_HBM2_HBM4_HBM6, VR_POWER_FAULT_4_REG, BIT(7), false },
	{ ARKE_VDDQ_HBM1_HBM3_HBM5_HBM7, VR_POWER_FAULT_4_REG, BIT(6), false },
	{ ARKE_P1V2_PLL_VDDA_OWL, VR_POWER_FAULT_4_REG, BIT(5), false },
	{ ARKE_P1V2_PLL_VDDA_SOC, VR_POWER_FAULT_4_REG, BIT(4), false },
	...
	// VR SMBUS ALERT
	{ ARKE_VDDQ_01234567_SMBALRT_N, VR_SMBUS_ALERT_EVENT_LOG_REG, BIT(0), false },
	{ ARKE_MAX_N_SMBALRT_N, VR_SMBUS_ALERT_EVENT_LOG_REG, BIT(1), false },
